...
class Rae_Register_Get_Posts_Catgory_Api {

	/**
	 * Constructor - in constructor we register the endpoints
	 */
	...
	/**
	 * Register posts endpoints. - creating custom endpoints
	 */
	public function rest_posts_endpoints() {
		 ...
		 *
		 * Example: http://example.com/wp-json/rae/v1/posts?page_no=1&category='painting'

		 * Description register_rest_route - this fucntion is provided by wordpress 
	...
	public function rest_endpoint_handler( WP_REST_Request $request ) {
		...
		$posts_data = $this->get_posts( $posts_page_no,$posts_category );
	 ...
	 * @return array Posts.
	 */
	public function get_posts( $page_no = 1,$post_category ) {
...
new Rae_Register_Get_Posts_Catgory_Api();
